...
// Các route cơ bản
userRouter.post('/create-user', authenticate, authorize(ROLES.SYSTEM_OWNER, ROLES.BRANCH_OWNER, ROLES.STAFF), validate(createUserSchema), userController.createUser);
