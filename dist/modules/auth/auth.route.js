...
import { loginSchema, refreshTokenSchema, changePasswordSchema, resetPasswordSchema } from './auth.schema.js';
...
authRouter.post('/reset-password/:userId', authenticate, authorize(ROLES.SYSTEM_OWNER, ROLES.BRANCH_OWNER), authorizeBranch, validate(resetPasswordSchema), authController.resetPassword);
